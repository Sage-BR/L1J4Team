...
public class L1TownLocation {
	...
	private static final Point[] GETBACK_LOC_SILVER_KNIGHT_TOWN = { new Point(33071, 33402), new Point(33091, 33396),
	...
	private static final Map<Integer, Point[]> townToEscapePoints = new HashMap<>();

	private static final Map<Integer, Integer> townToMap = new HashMap<>();

	static {
		townToEscapePoints.put(TOWNID_TALKING_ISLAND, GETBACK_LOC_TALKING_ISLAND);
		townToEscapePoints.put(TOWNID_SILVER_KNIGHT_TOWN, GETBACK_LOC_SILVER_KNIGHT_TOWN);
		...
		townToEscapePoints.put(TOWNID_RECLUSE_VILLAGE, GETBACK_LOC_RECLUSE_VILLAGE);
